...
#ifndef FELDRAND__DRAW_PLAIN_IMPLEMENTATION_HPP
#define FELDRAND__DRAW_PLAIN_IMPLEMENTATION_HPP

#include "DrawingRoutineImplementation.hpp"

namespace Feldrand {

class DrawPlainImplementation
    : public DrawingRoutine::DrawingRoutineImplementation {
public:
    DrawPlainImplementation();
...
#endif // FELDRAND__DRAW_PLAIN_IMPLEMENTATION_HPP
